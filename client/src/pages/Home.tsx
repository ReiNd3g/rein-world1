  ...
  return (
    <div className={`site-shell ${gateOpen ? "portfolio-unlocked" : "portfolio-locked"}`} onMouseEnter={() => setCursorVisible(true)} onMouseLeave={() => setCursorVisible(false)}>
      ...
      <main>
        ...
        <section id="journey" className="journey section-anchor dark-section"><div className="journey-identity"><span className="mono">REIN SCHLIEFFEN / 22</span><span className="mono">STUDENT · FREELANCER · APPLICANT</span></div>
